...
function LoadjQueryUI()
{
	...
	if ( typeof jQuery != 'function' && waitingForScript('http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.js', 'jQuery') ) return;
	...
	$.getScript( 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.10/jquery-ui.min.js', function() {
