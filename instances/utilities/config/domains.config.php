...
$config['redirections'] = array(
	array( 'from' => 'www.utils.vm', 'to' => 'http://utils.vm' ),
);

$config['utils.vm'] = array(
	'devel' => true,
	'instance' => 'utilities',
	'language' => 'en_US',
...
//	'www_as_subdomain' => false,
	'static_host' => 'http://utils.vm',
	'media_host' => 'http://utils.vm', // Alternative static content (media). Comment to disable.
	'database' => array(
...
$config['unit.test'] = $config['utils.vm'];
