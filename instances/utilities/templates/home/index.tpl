									...
									<form action="" method="POST">
										<fieldset>
											...
											<p>Use valid/invalid email:<br />
												<input type="text" name="email" value="{if isset($form_fields.email)}{$form_fields.email}{/if}" />
											</p>
											<p>Use valid/invalid phone:<br />
												<input type="text" name="phone" value="{if isset($form_fields.phone)}{$form_fields.phone}{/if}" />
											</p>
										</fieldset>
								...
								<div class="yui-u">
									<form action="" method="POST">
										<fieldset>
											...
											<p>Your email:<br />
												<input type="text" name="account_email" value="{if isset($inviter_email)}{$inviter_email}{/if}" />
											</p>
											<p>Your password:<br />
