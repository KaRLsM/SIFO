...
REM
REM Copyright (c) 2008-2011, Manuel Pichler <mapi@phpmd.org>.
...
if "%PHPBIN%" == "" set PHPBIN=D:\code\musicjumble\libs\php\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "D:\code\musicjumble\libs\php\phpmd" %*
