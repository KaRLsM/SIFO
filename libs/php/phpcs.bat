...
"D:\code\musicjumble\libs\php\php.exe" -d auto_append_file="" -d auto_prepend_file="" -d include_path="D:\code\musicjumble\libs\php\pear" "D:\code\musicjumble\libs\php\phpcs" %*
